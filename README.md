...
На макете - упрощённый экран личного кабинета организации-клиента. Сначала регистрируется общий аккаунт организации в системе, затем внутри личного кабинета создаются пользователи. Обслуживание пользователей ведется удаленно, обязательно нужно подтвердить номер пользователя перед началом работы.
